...
class Sun:
    ...
    def __init__(self, game, pos, velocity=[0,0], value=25, life=800, wave=True):
        self.game = game
        self.pos = list(pos)
        ...
        print(f"Tamaño de la imagen del sol: {self.img.get_size()}")  # Imprime el tamaño de la imagen escalada
