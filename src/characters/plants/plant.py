...
class Plant:
    def __init__(self, x, y, image_path, selection_image_path, animation_image_path, shooting_image_path, projectile_image_path=None, cost=0, recharge_time=0, attack_damage=0, health=0):
        ...
        self.projectile_image = pygame.image.load(projectile_image_path) if projectile_image_path else None
